...
01_data_preprocessing.ipynb
Data preprocessing and preparation workflow.

02_eda_&_analysis.ipynb
Exploratory data analysis, business analysis, visualizations, and statistical testing.

Power BI Dashboard

dashboard/vendor_performance_analysis.pbix

Contains the final interactive two-page dashboard.

Final Analytical Dataset

data/final_vendor_performance_summary.csv

Aggregated vendor-level dataset used for the final analysis.
